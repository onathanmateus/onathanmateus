## 👋 About Me:
HELLO WORLD 😁!!! <br> <p>My name is Nathan Mateus and my goal is to make the world of computing as accessible as possible to the end consumer through technical tools that allow them to have an unforgettable experience.</p> <p>I'm currently studying REACT.JS / NEXT. JS and TYPESCRIPT in order to further specialise in web frameworks (I already have experience in HTML5, CSS3, BOOTSTRAP, TAILWIND, JAVASCRIPT, JAVA, GIT/GITHUB and also with design tools such as FIGMA and GIMP), my next goal is to study REACT NATIVE in the near future, all the time I'm studying and creating practical projects in order to improve my learning (all of them are available on my Github profile).</p> <p>My desire to learn is insatiable, studying programming is very important to me, I'm totally dedicated to what I believe in and I never give up on my dreams, I love working as part of a team and I'm also calm and able to deal with day-to-day problems. I'm always open to new challenges and exciting projects, let's work together and create incredible solutions ?</p>
